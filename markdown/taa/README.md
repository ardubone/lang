...
1. Главная страница:
    1. Хэдер 
        ...
        - селектор выбора языка сайта [FE/BE/DB]
        - линк FAQ [FE]
    2. Тело   
        - текст О проекте [FE]
        - кнопка "Начать" [FE]
...
3. Личный кабинет просмотр записей
    1. функция просмотр списка записей [FE/BE/DB]
    3. функция просмотр видео [FE/BE/DB]
    3. функция прослушивание аудио [FE/BE/DB]
